            ...
            <div class="col-12">
                <div class="card">
                            ...
                            <tbody>
                                ...
                                <tr v-for="(contact , index) in contacts.data" :key="contact.id">
                                    ...
                                    <td>
                                        ...
                                        >{{contact.is_fav == 1 ? 'Yes' : 'NO' | upText}}</span>
                                    </td>
                                    <td>
                                        <button
                    ...
                    <div class="card-footer">
                        <pagination :data="contacts" @pagination-change-page="getContactPage"></pagination>
                    </div>
                    <!-- /.card-body -->
                </div>
                <!-- /.card -->
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addNewContactModalLabel">
                            ...
                            <span v-else>Add New</span> Contact
                        </h5>
                    ...
                    <form
                        @submit.prevent="editMode ? updateContact() : createContact()"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <textarea
                                    ...
                                    placeholder="About Contact (Optional)"
                                ></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    type="checkbox"
                                    name="is_fav"
                                    :class="{ 'is-invalid': form.errors.has('is_fav') }"
                                >
...
export default {
    ...
    methods: {
        ...
        getContactPage(page = 1) {
            axios.get("api/contact?page=" + page).then(({ data }) => {
                this.contacts = data;
                this.$Progress.finish();
            });
        }
