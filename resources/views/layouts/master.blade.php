	...
	<div class="wrapper" id="app">
		...
		<nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
			...
			<div class="form-inline ml-3">
				<div class="input-group input-group-sm">
					<input class="form-control form-control-navbar" @keyup.enter="searchGlobal" v-model="search" type="search" placeholder="Search" aria-label="Search">
					<div class="input-group-append">
						<button class="btn btn-navbar" @click="searchGlobal">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="{{route('home')}}" class="brand-link">
				<img src="{{asset('img/icon.png')}}" alt="Gustbook Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
